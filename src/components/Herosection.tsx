...
export default function HeroSection() {
  return (
    <section className="relative w-full bg-white text-[#0f0a1e]">
      <div className="mx-auto flex  flex-col items-center px-6 py-20 text-center md:py-28 lg:px-12">
...
<div className="">
        <h1 className="max-w-4xl font-serif text-[44px] font-light leading-[1.05] tracking-tight md:text-6xl lg:text-7xl">
          ARA Face Bowl
        </h1>

        <p className="mt-5 max-w-xl text-base leading-relaxed text-[#6b7280] p-5 md:text-lg">
        ...
        <div className="mt-10 w-full max-w-4xl overflow-hidden rounded-2xl border border-[rgba(124,58,237,0.1)] shadow-[0_8px_40px_rgba(124,58,237,0.08)]">
          <video
